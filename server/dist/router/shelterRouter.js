...
router.post("/booking", middlewares_1.csrfProtection, (0, validate_1.validate)(schemas_1.postBookingSchema), (0, catchAsync_1.default)(shelterController_1.default.postBooking));
router
    .route("/rates/:shelterId")
    .get((0, catchAsync_1.default)(shelterController_1.default.getRatesByShelterId))
    .put(middlewares_1.csrfProtection, (0, validate_1.validate)(schemas_1.putRatesSchema), (0, catchAsync_1.default)(shelterController_1.default.editRates));
